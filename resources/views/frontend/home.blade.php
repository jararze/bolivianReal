                ...
                @foreach(site_config('home_info.steps', []) as $index => $step)
                    <div class="col-sm-4 submit-property-placeholder">
                        <div class="image-wrapper">
                            <img src="{{ asset('assets/front/images/demo/icon-'.($index + 1).'.svg') }}"
                                 alt="{{ $step['title'] ?? '' }}"/>
                        </div>
                                ...
                                <header class="entry-header">
                                    ...
                                    <div class="price-and-status">
                                        ...
                                        @if($property->market_status === 'off_market')
                                            <span class="property-status-tag"
                                                  style="background-color: #dc3545; opacity: 0.9;">
                                                {{ strtoupper($property->getOffMarketReasonLabel()) }}
                                            </span>
                                        @else
                                            <span class="property-status-tag">
                                                {{ $property->is_project ? 'PROYECTO' : $property->serviceType?->name ?? 'EN VENTA' }}
                                            </span>
                                        @endif
                                    </div>
                                </header>
