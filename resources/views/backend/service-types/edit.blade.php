    ...
    <div class="container-fixed">
        <div class="grid gap-5 lg:gap-7.5 xl:w-[38.75rem] mx-auto">
            <div class="card pb-2.5">
                ...
                <form method="post" action="{{ route('backend.service-types.update', $serviceType->id) }}" class="mt-6 space-y-6">
                    @csrf
                    @method('PUT')
                    <div class="card-body grid gap-5">
                        <div class="flex items-baseline gap-2.5 w-full">
                            ...
                            <div class="w-3/4">
                                <x-text-input id="name" name="name" type="text" :value="$serviceType->name" autofocus required
