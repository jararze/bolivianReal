        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-7.5">
            <div class="col-span-2">
                <div class="flex flex-col gap-5 lg:gap-7.5">
                    ...
                    <div class="card min-w-full">
                        ...
                        <form method="post" action="{{ route('backend.configurations.store.mainData') }}">
                            @csrf
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z"
                                ...
                                <p class="text-sm text-gray-700">
                                    Integrate modifier keys for activating shortcuts to streamline your navigation and
                                    enhance productivity without disrupting your typing flow.
                                </p>
                                <a class="btn btn-link flex-none" href="#">
                                    Learn more
                                </a>
                            ...
                            <span
                                class="hidden [&:not(:last-child)]:block [&:not(:last-child)]:border-b border-b-gray-200">
             </span>
                            <div class="flex flex-col items-start gap-2.5">
                                <div class="mb-2.5">
                                    <div class="relative size-[50px] shrink-0">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z"
                                ...
                                <p class="text-sm text-gray-700">
                                    Switch to a high-contrast color scheme to improve on-screen text readability, reduce
                                    eye strain, and facilitate better visual ergonomics for long work sessions.
                                </p>
                                <a class="btn btn-link flex-none" href="#">
                                    Learn more
                                </a>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z"
                                ...
                                <p class="text-sm text-gray-700">
                                    Customize your video engagement experience with user-centric autoplay settings that
                                    align with your system preferences or manual selection for a tailored approach.
                                </p>
                                <a class="btn btn-link flex-none" href="#">
                                    Learn more
                                </a>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z"
                                ...
                                <p class="text-sm text-gray-700">
                                    Enhance your workflow integration by configuring external links to open seamlessly
                                    within the desktop application, providing a unified and efficient user experience.
                                </p>
                                <a class="btn btn-link flex-none" href="#">
                                    Learn more
                                </a>
