<x-app-layout>
    <x-slot name="header">
        <h1 class="font-medium text-base text-gray-900">Nuevo Usuario</h1>
                ...
                <div class="flex flex-col items-stretch grow gap-5 lg:gap-7.5">
                    ...
                    <div class="card p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Contraseña -->
                            <div class="grid grid-cols-4 gap-4 items-center">
                                <x-input-label for="password" value="Contraseña" class="text-gray-700 required" />
                                <div class="col-span-3 grid grid-cols-2 gap-4">
                                    <div>
                                        <x-text-input
                                            id="password"
                                ...
                                <div class="col-span-3 grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <x-text-input
                                            ...
                                            type="text"
                                            class="w-full"
                                            placeholder="Cargo (ej: Agente Senior)"
                                            :value="old('jobtitle')"
                                        />
                            ...
                            <div class="grid grid-cols-4 gap-4 items-center">
                                ...
                                <div class="col-span-3">
                                    ...
                                    <p class="text-xs text-gray-600 mt-1">
                                        ...
                                        <strong>Agente:</strong> Gestión de propiedades.
