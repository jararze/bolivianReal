<!-- Card de Cliente/Propietario - EDIT VERSION -->
<div class="card p-6" id="client_info">
        ...
        <div class="flex gap-2">
            <div class="flex-1 relative">
                ...
                <input
                    ...
                    autocomplete="off"
                    value="{{ $property->client ? $property->client->full_name : '' }}"
                >
    ...
    <div id="client_form">
        <input type="hidden" name="client_id" id="client_id" value="{{ $property->client_id ?? '' }}">
        ...
        <div class="space-y-6">
                ...
                <div class="col-span-3 grid grid-cols-2 gap-4">
                    <div>
                        <x-text-input
                            ...
                            class="w-full"
                            placeholder="Nombre"
                            value="{{ old('client_name', $property->client->name ?? '') }}"
                            required
                        />
                    ...
                    <div>
                        <x-text-input
                            ...
                            value="{{ old('client_lastname', $property->client->lastname ?? '') }}"
                        />
                ...
                <div class="col-span-3 grid grid-cols-2 gap-4">
                    <div>
                        <x-text-input
                            ...
                            value="{{ old('client_phone', $property->client->phone ?? '') }}"
                        />
                    ...
                    <div>
                        <x-text-input
                            ...
                            class="w-full"
                            placeholder="Email"
                            value="{{ old('client_email', $property->client->email ?? '') }}"
                        />
                ...
                <div class="col-span-3 grid grid-cols-2 gap-4">
                    <div>
                        <x-text-input
                            ...
                            value="{{ old('client_ci', $property->client->ci ?? '') }}"
                        />
                    ...
                    <div>
                        <x-text-input
                            ...
                            class="w-full"
                            placeholder="Ciudad"
                            value="{{ old('client_city', $property->client->city ?? '') }}"
                        />
            ...
            <div class="grid grid-cols-4 gap-4 items-center">
                ...
                <div class="col-span-3">
                    <x-text-input
                        ...
                        value="{{ old('client_address', $property->client->address ?? '') }}"
                    />
            ...
            <div class="grid grid-cols-4 gap-4 items-start">
                ...
                <div class="col-span-3">
                    ...
                    >{{ old('client_notes', $property->client->notes ?? '') }}</textarea>
        ...
        @if($property->client)
            <div class="alert alert-primary mt-4 items-center" id="client_selected_alert">
                <i class="ki-filled ki-information-2"></i>
                <span id="client_selected_text">Cliente actual: {{ $property->client->full_name }}</span>
        ...
        @else
            <div class="alert alert-primary mt-4 items-center hidden" id="client_selected_alert">
                <i class="ki-filled ki-information-2"></i>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Si hay cliente actual, deshabilitar campos
            @if($property->client)
            disableClientFields(true);
            selectedAlert.classList.remove('hidden');
            @else
            ...
            newClientBtn.addEventListener('click', function() {
                ...
                selectedAlert.classList.add('hidden');
                disableClientFields(false);
