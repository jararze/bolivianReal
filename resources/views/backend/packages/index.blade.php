                        ...
                        <div class="flex flex-col gap-5 lg:gap-7.5">
                            <div class="flex flex-col gap-3 text-center">
                                ...
                                <p class="text-sm text-gray-800">
                                    Define fácilmente un nuevo paquete para subir propiedades, ajustando las características,
                                    <br/>
                                    límites y precios según las necesidades de tu plataforma.
                                </p>
                            </div>
                            <div class="flex justify-center mb-5">
                                <a class="btn btn-primary" href="{{ route('backend.packages.create') }}">
                                    Crear nuevo paquete
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="scrollable-x-auto">
                                <table class="table table-fixed table-border" data-datatable-table="true">
                                    ...
                                    <tr>
                                        ...
                                        <th class="w-[100px]">
                                            <span class="sort"><span class="sort-label text-gray-700 font-normal">Monto</span><span
                                                    class="sort-icon"></span></span>
                                        </th>
                                        <th class="w-[100px]">
            ...
            <div id="deleteModal" class="modal" data-modal-backdrop-static="true" data-modal="true">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            Preguntas Frecuentes (FAQ) - Compra de Paquetes
                        </h3>
                    </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Cómo funciona el sistema de créditos para subir propiedades?
                    </span>
                                ...
                                <div class="accordion-content hidden" id="faq_1_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        Cada crédito te permite subir una propiedad a la plataforma. La propiedad estará activa hasta que se dé de baja o se venda. Cuando eso suceda, el crédito se restaura y puedes usarlo nuevamente.
                                    </div>
                                </div>
                            </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Cuánto tiempo es válido un crédito?
                    </span>
                                    <i class="ki-filled ki-plus text-gray-600 text-sm accordion-active:hidden block"></i>
                                    <i class="ki-filled ki-minus text-gray-600 text-sm accordion-active:block hidden"></i>
                                </button>
                                <div class="accordion-content hidden" id="faq_2_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        La validez de los créditos depende del paquete adquirido. Algunos paquetes tienen una duración de 30 días, mientras que otros pueden ser válidos por hasta un año.
                                    </div>
                                </div>
                            </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Qué sucede si no utilizo todos mis créditos antes de que expiren?
                                ...
                                <div class="accordion-content hidden" id="faq_3_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        Si los créditos no se utilizan antes de su fecha de expiración, se perderán automáticamente. Te recomendamos planificar el uso de tus créditos según las necesidades de tu negocio.
                                    </div>
                                </div>
                            </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Puedo comprar más créditos si me quedo sin ellos?
                    </span>
                                    <i class="ki-filled ki-plus text-gray-600 text-sm accordion-active:hidden block"></i>
                                    <i class="ki-filled ki-minus text-gray-600 text-sm accordion-active:block hidden"></i>
                                </button>
                                <div class="accordion-content hidden" id="faq_4_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        Sí, puedes adquirir más créditos en cualquier momento comprando un nuevo paquete desde la sección de "Paquetes" en tu panel de control.
                                    </div>
                                </div>
                            </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Cómo elijo el paquete adecuado para mis necesidades?
                    </span>
                                    <i class="ki-filled ki-plus text-gray-600 text-sm accordion-active:hidden block"></i>
                                    <i class="ki-filled ki-minus text-gray-600 text-sm accordion-active:block hidden"></i>
                                </button>
                                <div class="accordion-content hidden" id="faq_5_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        Depende de cuántas propiedades planeas gestionar. Si necesitas subir muchas propiedades frecuentemente, un paquete con más créditos y mayor duración será más conveniente.
                                    </div>
                                </div>
                            </div>
                        </div>
