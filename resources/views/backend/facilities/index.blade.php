<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="flex items-center flex-wrap gap-1 text-sm">
            <a class="text-gray-700 hover:text-primary" href="{{ route('backend.facilities.index') }}">
                {{ __('Servicios Cercanos') }}
            </a>
                        ...
                        <div class="flex flex-col gap-5 lg:gap-7.5">
                            <div class="flex flex-col gap-3 text-center">
                                <h2 class="text-1.5xl font-semibold text-gray-900">
                                    Crear un Nuevo Servicio Cercano
                                </h2>
                                <p class="text-sm text-gray-800">
                                    Agrega fácilmente un nuevo servicio cercano como hospitales, escuelas,
                                    supermercados,
                                    <br/>
                                    u otros servicios importantes para tus propiedades.
                                </p>
                            </div>
                            <div class="flex justify-center mb-5">
                                <a class="btn btn-primary" href="{{ route('backend.facilities.create') }}">
                ...
                <div class="card card-grid min-w-full">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="flex gap-6 items-center">
                            ...
                            <a class="btn btn-primary" href="{{ route('backend.facilities.create') }}">
                                Agregar nuevo servicio cercano
                            </a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex flex-col gap-1.5">
                                                    <a class="leading-none font-medium text-sm text-gray-900 hover:text-primary"
                                                       href="{{ route("backend.facilities.edit", $facility->id) }}">
                                                        {{ $facility->name }}
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-icon btn-clear btn-light"
                                                        ...
                                                        data-title="{{ $facility->name }}" data-id="{{ $facility->id }}">
            ...
            <div id="deleteModal" class="modal" data-modal-backdrop-static="true" data-modal="true">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            Preguntas Frecuentes (FAQ) - Servicios Cercanos
                        </h3>
                    </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Cómo creo un nuevo servicio cercano?
                    </span>
                                ...
                                <div class="accordion-content hidden" id="faq_1_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        Para crear un nuevo servicio cercano, ve al menú "Servicios Cercanos" y haz clic en "Agregar Nuevo". Llena el formulario con el nombre, categoría, y descripción del servicio, luego guarda los cambios.
                                    </div>
                                </div>
                            </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Qué información es obligatoria al crear un servicio cercano?
                    </span>
                                    <i class="ki-filled ki-plus text-gray-600 text-sm accordion-active:hidden block"></i>
                                    <i class="ki-filled ki-minus text-gray-600 text-sm accordion-active:block hidden"></i>
                                </button>
                                <div class="accordion-content hidden" id="faq_2_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        El campo "Nombre" es obligatorio y debe ser único. La categoría y la descripción son opcionales pero recomendados para una mejor organización.
                                    </div>
                                </div>
                            </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Puedo editar un servicio cercano después de crearlo?
                    </span>
                                    <i class="ki-filled ki-plus text-gray-600 text-sm accordion-active:hidden block"></i>
                                    <i class="ki-filled ki-minus text-gray-600 text-sm accordion-active:block hidden"></i>
                                </button>
                                <div class="accordion-content hidden" id="faq_3_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        Sí, puedes editar un servicio cercano en cualquier momento. Simplemente selecciona el servicio en la lista, haz clic en "Editar" y realiza los cambios necesarios.
                                    </div>
                                </div>
                            </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Cómo elimino un servicio cercano?
                    </span>
                                    <i class="ki-filled ki-plus text-gray-600 text-sm accordion-active:hidden block"></i>
                                    <i class="ki-filled ki-minus text-gray-600 text-sm accordion-active:block hidden"></i>
                                </button>
                                <div class="accordion-content hidden" id="faq_4_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        Para eliminar un servicio cercano, selecciona el registro en la lista y haz clic en "Eliminar". Ten en cuenta que esta acción no se puede deshacer.
                                    </div>
                                </div>
                            </div>
                    ...
                    <span class="text-base text-gray-900">
                        ¿Puedo asociar un servicio cercano con múltiples propiedades?
                    </span>
                                    <i class="ki-filled ki-plus text-gray-600 text-sm accordion-active:hidden block"></i>
                                    <i class="ki-filled ki-minus text-gray-600 text-sm accordion-active:block hidden"></i>
                                </button>
                                <div class="accordion-content hidden" id="faq_5_content">
                                    <div class="text-gray-700 text-md pb-4">
                                        Sí, un servicio cercano puede asociarse con múltiples propiedades para proporcionar información útil sobre la accesibilidad de esos servicios en las cercanías de cada propiedad.
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('[data-modal-toggle="#deleteModal"]').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    // Update form action
                    deleteForm.action = `/facilities/${id}`;
                });
            });
        });
    </script>
