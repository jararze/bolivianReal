                        ...
                        <div class="flex flex-col gap-5 lg:gap-7.5">
                            <div class="flex flex-col gap-3 text-center">
                                ...
                                <p class="text-sm text-gray-800">
                                    Agrega fácilmente una nueva ciudad para mejorar la organización y gestión de tus propiedades.
                                    <br/>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <input class="checkbox checkbox-sm" data-datatable-row-check="true"
                                                       type="checkbox" value="{{ $city->id }}"/>
                                            </td>
                                            <td>
                                                <div class="flex flex-col gap-1.5">
                                                    <a class="leading-none font-medium text-sm text-gray-900 hover:text-primary"
                                                       href="{{ route('backend.cities.edit', $city->id) }}">
                                                        {{ $city->name }}
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-icon btn-clear btn-light"
                                                        ...
                                                        data-title="{{ $city->name }}" data-id="{{ $city->id }}">
