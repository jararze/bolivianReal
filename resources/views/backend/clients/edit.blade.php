<x-app-layout>
    <x-slot name="header">
        <h1 class="font-medium text-base text-gray-900">Editar Cliente</h1>
            ...
            <div class="flex gap-5 lg:gap-7.5">
                ...
                <div class="hidden lg:block w-[230px] shrink-0">
                    <div class="w-[230px]" data-sticky="true" data-sticky-class="fixed z-[4] left-auto top-[3rem]" data-sticky-offset="200">
                        ...
                        <a href="{{ route('backend.clients.show', $client) }}" class="btn btn-light w-full mb-2">
                ...
                <!-- Formulario (igual que create pero con valores precargados) -->
                            ...
                            <div class="grid grid-cols-4 gap-4 items-center">
                                ...
                                <div class="col-span-3">
                                    <select id="client_type" name="client_type" class="select w-full" required>
                                        ...
                                        <option value="buyer" {{ old('client_type', $client->client_type) === 'buyer' ? 'selected' : '' }}>Comprador</option>
                                        <option value="tenant" {{ old('client_type', $client->client_type) === 'tenant' ? 'selected' : '' }}>Inquilino</option>
                                        <option value="both" {{ old('client_type', $client->client_type) === 'both' ? 'selected' : '' }}>Propietario e Inquilino</option>
                                    </select>
