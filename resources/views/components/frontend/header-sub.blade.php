...
{{--                                         style="height: 90px; vertical-align: top; max-width: 100%; object-fit: contain;"/>--}}
                        ...
                        <ul class="main-menu clearfix" style="display: flex; justify-content: center; margin: 0; padding: 0; list-style: none; align-items: center; font-size: 12px">
                            <li class="{{ Route::currentRouteName() == 'frontend.home' ? 'current-menu-item' : '' }}" style="margin: 0 2px;">
                                <a href="{{ route('frontend.home') }}"
                                   ...
                                   onmouseout="this.style.background='{{ Route::currentRouteName() == 'frontend.home' ? 'rgba(0, 123, 255, 0.2)' : 'transparent' }}'; this.style.transform='translateY(0)'">
                                    INICIO
                                </a>
                            </li>
                            <li class="{{ Route::currentRouteName() == 'frontend.properties.search' ? 'current-menu-item' : '' }}" style="margin: 0 2px;">
                                <a href="{{ route('frontend.properties.search') }}"
                                   style="padding: 15px 25px; color: #fff; display: block; border-radius: 8px; transition: all 0.3s ease; text-decoration: none; position: relative; {{ Route::currentRouteName() == 'frontend.properties.search' ? 'background: rgba(0, 123, 255, 0.2);' : '' }}"
                                   onmouseover="this.style.background='rgba(255, 255, 255, 0.15)'; this.style.transform='translateY(-2px)'"
                                   onmouseout="this.style.background='{{ Route::currentRouteName() == 'frontend.properties.search' ? 'rgba(0, 123, 255, 0.2)' : 'transparent' }}'; this.style.transform='translateY(0)'">
                                    PROPIEDADES
                                </a>
                            </li>
                            <li class="{{ Route::currentRouteName() == 'frontend.about' ? 'current-menu-item' : '' }}" style="margin: 0 2px;">
                                <a href="{{ route('frontend.about') }}"
                                   style="padding: 15px 25px; color: #fff; display: block; border-radius: 8px; transition: all 0.3s ease; text-decoration: none; position: relative; {{ Route::currentRouteName() == 'frontend.about' ? 'background: rgba(0, 123, 255, 0.2);' : '' }}"
                                   onmouseover="this.style.background='rgba(255, 255, 255, 0.15)'; this.style.transform='translateY(-2px)'"
                                   onmouseout="this.style.background='{{ Route::currentRouteName() == 'frontend.about' ? 'rgba(0, 123, 255, 0.2)' : 'transparent' }}'; this.style.transform='translateY(0)'">
                                    QUIÉNES SOMOS
                                </a>
                            </li>
                            <li class="{{ Route::currentRouteName() == 'frontend.services' ? 'current-menu-item' : '' }}" style="margin: 0 2px;">
                                <a href="{{ route('frontend.services') }}"
                                   style="padding: 15px 25px; color: #fff; display: block; border-radius: 8px; transition: all 0.3s ease; text-decoration: none; position: relative; {{ Route::currentRouteName() == 'frontend.services' ? 'background: rgba(0, 123, 255, 0.2);' : '' }}"
                                   onmouseover="this.style.background='rgba(255, 255, 255, 0.15)'; this.style.transform='translateY(-2px)'"
                                   onmouseout="this.style.background='{{ Route::currentRouteName() == 'frontend.services' ? 'rgba(0, 123, 255, 0.2)' : 'transparent' }}'; this.style.transform='translateY(0)'">
                                    SERVICIOS
                                </a>
                            </li>
                            ...
                            <li class="{{ Route::currentRouteName() == 'frontend.contact' ? 'current-menu-item' : '' }}" style="margin: 0 2px;">
                                <a href="{{ route('frontend.contact') }}"
                                   style="padding: 15px 25px; color: #fff; display: block; border-radius: 8px; transition: all 0.3s ease; text-decoration: none; position: relative; {{ Route::currentRouteName() == 'frontend.contact' ? 'background: rgba(0, 123, 255, 0.2);' : '' }}"
                                   onmouseover="this.style.background='rgba(255, 255, 255, 0.15)'; this.style.transform='translateY(-2px)'"
                                   onmouseout="this.style.background='{{ Route::currentRouteName() == 'frontend.contact' ? 'rgba(0, 123, 255, 0.2)' : 'transparent' }}'; this.style.transform='translateY(0)'">
                                    CONTÁCTANOS
                                </a>
                            </li>
                        </ul>
                    ...
                    <!-- REDES SOCIALES -->
                    <div class="social-links" style="display: flex; align-items: center; gap: 15px; margin-left: 20px;">
                        <a href="https://wa.me/59177777777" target="_blank"
                           style="color: #fff; font-size: 20px; padding: 8px; border-radius: 50%; background: rgba(255,255,255,0.1); transition: all 0.3s ease; text-decoration: none; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;"
                           onmouseover="this.style.background='#25D366'; this.style.transform='translateY(-2px)'"
                           onmouseout="this.style.background='rgba(255,255,255,0.1)'; this.style.transform='translateY(0)'"
                           title="WhatsApp">
                            <i class="fab fa-whatsapp"></i>
                        </a>
                        <a href="https://instagram.com/bolivianrealestate" target="_blank"
                           style="color: #fff; font-size: 20px; padding: 8px; border-radius: 50%; background: rgba(255,255,255,0.1); transition: all 0.3s ease; text-decoration: none; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;"
                           onmouseover="this.style.background='linear-gradient(45deg, #f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%)'; this.style.transform='translateY(-2px)'"
                           onmouseout="this.style.background='rgba(255,255,255,0.1)'; this.style.transform='translateY(0)'"
                           title="Instagram">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a href="https://tiktok.com/@bolivianrealestate" target="_blank"
                           style="color: #fff; font-size: 20px; padding: 8px; border-radius: 50%; background: rgba(255,255,255,0.1); transition: all 0.3s ease; text-decoration: none; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;"
                           onmouseover="this.style.background='#000000'; this.style.transform='translateY(-2px)'"
                           onmouseout="this.style.background='rgba(255,255,255,0.1)'; this.style.transform='translateY(0)'"
                           title="TikTok">
                            <i class="fab fa-tiktok"></i>
                        </a>
                        <a href="https://facebook.com/bolivianrealestate" target="_blank"
                           style="color: #fff; font-size: 20px; padding: 8px; border-radius: 50%; background: rgba(255,255,255,0.1); transition: all 0.3s ease; text-decoration: none; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;"
                           onmouseover="this.style.background='#1877F2'; this.style.transform='translateY(-2px)'"
                           onmouseout="this.style.background='rgba(255,255,255,0.1)'; this.style.transform='translateY(0)'"
                           title="Facebook">
