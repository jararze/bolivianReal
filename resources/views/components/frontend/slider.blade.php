                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <h3 class="slide-entry-title entry-title">
                                        <a href="property-single.html" rel="bookmark">{{ $property->name }}</a>
                                    </h3>
                                    <div class="price-and-status">
                                        <span class="price">{{ $property->currency }} {{ number_format($property->lowest_price, 2) }}</span>
                                        <a href="#">
                                            <span class="property-status-tag">{{ $property->serviceType->name }}</span>
                                        </a>
                                    </div>
                                </div>
...
{{--                    <img src="{{ asset("assets/front/images/slider/20240226_173113.jpg")}}" alt="Casa en Merrick Way" style="max-height: 800px;">--}}
                    @if($property->thumbnail)
                        <img src="{{ asset($property->thumbnail) }}"
                             alt="{{ $property->name }}" style="max-height: 800px">
                    @else
                        <img src="{{ asset('assets/front/images/default-property.jpg') }}"
        ...
        @empty
            <li>
                <div class="slide-overlay">
                    <div class="container">
                        <h3>No hay propiedades configuradas para el slider</h3>
                    </div>
                </div>
            </li>
        @endforelse
